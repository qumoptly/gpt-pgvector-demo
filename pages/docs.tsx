    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen py-2 mx-auto">
        ...
        <main className="flex flex-col items-center justify-center flex-1 w-full min-h-screen px-4 py-2 mx-auto mt-12 text-center sm:mt-20">
          <h1 className="max-w-xl text-xl font-bold sm:text-2xl">
            Demo about docs!
          </h1>
            ...
            <AnimatePresence mode="wait">
              <motion.div className="my-10 space-y-10">
                {answer && (
                  <>
                    <div>
                      <h3 className="mx-auto text-xl font-bold sm:text-2xl">
                        ✍ 回答:{" "}
                      </h3>
                    </div>
          ...
          <div className="max-w-xl text-xs">
            ...
            <ul>
              <li><a href="">https://www.rp-photonics.com</a></li>
              <li><a target="_blank" href="https://www.rp-photonics.com/encyclopedia.html">Encyclopedia</a></li>
              <li><a href="">数据量小于1k.</a></li>
            </ul>
            </div>
